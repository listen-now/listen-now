...
from projext.Sync.XiamiSynv.apiRequestsBase import HttpRequest, ignored
import io
import sys
...
class XiamiApi(HttpRequest):
    ...
    def getPlaylist(self, id):
        url = 'http://api.xiami.com/web?v=2.0&app_key=1&id={0}'.format(id) + \
...
if __name__ == '__main__':
    a = xiami.get_url_by_id('1769598761')
